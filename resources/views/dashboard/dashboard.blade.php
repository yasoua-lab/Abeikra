    ...
    <div class="row">
          ...
          <div class="card">
              <div class="card-header p-3 pt-2">
                  <div class="icon icon-lg icon-shape bg-gradient-primary shadow-primary text-center border-radius-xl mt-n4 position-absolute">
                      <i class="material-icons opacity-10">ondemand_video</i>
                  </div>
                  <div class="text-end pt-1">
                      <p class="text-sm mb-0 text-capitalize">Live Videos</p>
                      <h4 class="mb-0">75</h4>
                  </div>
              </div>
              <hr class="dark horizontal my-0">
      ...
      <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
              <div class="card-header p-3 pt-2">
                  ...
                  <div class="text-end pt-1">
                      <p class="text-sm mb-0 text-capitalize">Chats</p>
      ...
      <div class="col-xl-3 col-sm-6 mb-xl-0 mt-4">
          <div class="card">
              <div class="card-header p-3 pt-2">
                  ...
                  <div class="text-end pt-1">
                      <p class="text-sm mb-0 text-capitalize">Certified</p>
                      <h4 class="mb-0">250</h4>
                  </div>
              </div>
              <hr class="dark horizontal my-0">
              <div class="card-footer p-3">
                  <p class="mb-0"><span class="text-success text-sm font-weight-bolder">+20% </span>than last month</p>
              </div>
          </div>
      </div>
      ...
      <div class="col-xl-3 col-sm-6 mb-xl-0 mt-4">
          <div class="card">
              <div class="card-header p-3 pt-2">
                  ...
                  <div class="text-end pt-1">
                      <p class="text-sm mb-0 text-capitalize">Authenticate Certificate</p>
                      <h4 class="mb-0">85</h4>
                  </div>
              </div>
              <hr class="dark horizontal my-0">
      ...
      <div class="col-xl-3 col-sm-6 mb-xl-0 mt-4">
          <div class="card">
              <div class="card-header p-3 pt-2">
                  ...
                  <div class="text-end pt-1">
                      <p class="text-sm mb-0 text-capitalize">Library</p>
                      <h4 class="mb-0">1,000</h4>
                  </div>
              </div>
              <hr class="dark horizontal my-0">
              <div class="card-footer p-3">
                  <p class="mb-0"><span class="text-success text-sm font-weight-bolder">+7% </span>than last month</p>
              </div>
          </div>
      </div>
      ...
      <div class="col-xl-3 col-sm-6 mb-xl-0 mt-4 mb-4">
          <div class="card">
              <div class="card-header p-3 pt-2">
                  ...
                  <div class="text-end pt-1">
                      <p class="text-sm mb-0 text-capitalize">Traders</p>
      ...
      <div class="col-xl-3 col-sm-6 mb-xl-0 mt-4 mb-4">
          <div class="card">
              ...
              <hr class="dark horizontal my-0">
              <div class="card-footer p-3">
                  <p class="mb-0"><span class="text-success text-sm font-weight-bolder">+8% </span>than last week</p>
              </div>
          </div>
      </div>
    </div>
